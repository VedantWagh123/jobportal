...
import { registerInstitute, loginInstitute, getInstituteProfile, updateInstituteProfile, getPublicDistricts, refreshInstituteToken } from '../../controllers/institute/instituteAuthController.js';
...
router.post('/refresh', refreshInstituteToken);
